<?php
        include "../DoAnChuyenNghanh2/db/connect.php";
...
<!-- <?php 
    ...
    if(isset($_POST['submittimkiemadmin'])){
        $tukhoa = $_POST['tukhoaadmin'];
    }

    $sql_look = "SELECT * FROM tbl_khachhang WHERE tenkh LIKE '%".$tukhoa."%'";
...
<body>
    ...
    <div class="container-fluid">
        ...
        <!-- <h3>Từ khóa tìm kiếm: <?php $_POST['tukhoaadmin']; ?></h3>
        <div class="card-body">
                        ...
                        $i = 1;
                            while($row = mysqli_fetch_array($query_look)){?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-warning" href="sua.php?id=<?php echo $row['id']; ?>">Sửa</a> <a class="btn btn-primary" href="xoa.php?id=<?php echo $row['id']; ?>">Xóa</a></td>                                    
                                </tr>
                           <?php } ?>
                        ...
                        $i = 1;
                            while($row = mysqli_fetch_array($query)){?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-warning" href="sua.php?id=<?php echo $row['khachhang_id']; ?>">Sửa</a> <a class="btn btn-primary" href="xoa.php?id=<?php echo $row['khachhang_id']; ?>">Xóa</a></td>                                    
                                </tr>
                           <?php } ?>
