...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="nutthem">
            <a href="themdanhmuc.php" class="btn btn-success">Thêm</a>
        </div>
                        ...
                        $i = 1;
                            while($row = mysqli_fetch_array($query)){?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-warning" href="suadanhmuc.php?id=<?php echo $row['id']; ?>">Sửa</a> <a class="btn btn-primary" href="xoadanhmuc.php?id=<?php echo $row['id']; ?>">Xóa</a></td>                                    
                                </tr>
                           <?php } ?>
