...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="admin.php?quanly=submittimkiemadmin" method="post">
            <div>
                <input type="text" name="tukhoaadmin" placeholder="Nhập sản phẩm cần tìm kiếm">
                <input type="submit" name="submittimkiemadmin" value="Tìm kiếm">
            </div>
        </form>
                        ...
                        $i = 1;
                            while($row = mysqli_fetch_array($query_look)){?>
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td>
                                        <img src="hinhanh/<?php echo $row['image']; ?>"width="150px;">
